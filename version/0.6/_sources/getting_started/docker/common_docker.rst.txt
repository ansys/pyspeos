...
.. tab-set::
    ...
    .. tab-item:: Powershell
        ...
        .. code-block:: pwsh
            ...
            docker run --detach --name speos-rpc -p 127.0.0.1:50098:50098 -e ANSYSLMD_LICENSE_FILE=$env:LICENSE_SERVER --entrypoint /app/SpeosRPC_Server.x ghcr.io/ansys/speos-rpc:252 --host 0.0.0.0
