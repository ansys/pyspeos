...
lxp = script.LightPathFinder(speos=speos_server, path='path_to_lpf')
...
found_items = project.find(name='.*', name_regex=True, feature_type= script.simulation.Direct)
...
s_source.set_flux_luminous(683) # overwritten
s_source.set_flux_radiant(1) # overwritten
s_source.set_flux_luminous_intensity(5) # overwritten
...
# for any conflicting property the last set property counts
r_source.set_flux_from_rayfile() # overwritten
r_source.set_flux_luminous(683) # overwritten
r_source.set_flux_radiant(1) # counts
...
# for any conflicting property the last set property counts
mat1.set_surface_mirror(80.0) # overwritten
mat1.set_surface_opticalpolished() # overwritten
mat1.set_surface_library('path/surface.brdf') # counts
# Choose on way of setting Volume Properties
mat1.set_volume_none() # overwritten
mat1.set_volume_opaque() # overwritten
mat1.set_volume_optic(index=1.7, absorption=0.01, constringence=55) # overwritten
mat1.set_volume_library('path/mat.material') # counts
# Geometry
mat1.set_geometries(
    [script.GeoRef.from_native_link(
        geopath='TheBodyB')])
...
```{python}
#| eval: false
i_sensor = project.create_sensor(name='Irradiance.1', feature_type=script.sensor.Irradiance)
