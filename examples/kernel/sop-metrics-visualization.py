...
try:
    ...
    # requested wavelength. It is the integrated response over all incident
    # and outgoing angles.
    global_config = make_global_rta_config([380, 550, 700])

    # Directional RTA returns the integrated response
    # for a given incident angle over all outgoing angles.
    # The incidence is determined by the impact definition.
    ...
    # Define the normal impact used for the first set of BSDF slices.
    ...
    # Define the angled impact used for the second set of BSDF slices.
